# 项目介绍
本项目是一个全栈应用，包含两个主要部分：基于Next.js的后端API服务和基于Vite+Vue的前端应用。开发这个项目是自己在实践中遇见的一些问题，**以及对于前端的学习的再实践。懂的越多就了解的越少，每次面试每次相信大家都会经历一次蜕变，记录每次面试的学习，有很多是别人的项目我会标明出处，在这个ai大行其道的今天。落实自己也同样重要，分享自己的知识，希望能帮助到大家**
## 项目结构
